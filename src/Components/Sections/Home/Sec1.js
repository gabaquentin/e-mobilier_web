                                                ...
                                                <div className="geodir-category-img">
                                                    ...
                                                    <div className="geodir-category-opt">
                                                        <div className="geodir-category-opt_title">
                                                            ...
                                                            <div className="geodir-category-location"><a href="#"><i className="fas fa-map-marker-alt"></i>  34-42 Montgomery St , NY, USA</a></div>
                                                        </div>
                                                ...
                                                <div className="geodir-category-img">
                                                    ...
                                                    <div className="geodir-category-opt">
                                                        <div className="geodir-category-opt_title">
                                                            ...
                                                            <div className="geodir-category-location"><a href="#"><i className="fas fa-map-marker-alt"></i>  70 Bright St New York, USA</a></div>
                                                        </div>
                                                        <div className="listing-rating-count-wrap">
                                                ...
                                                <div className="geodir-category-img">
                                                    ...
                                                    <div className="geodir-category-opt">
                                                        <div className="geodir-category-opt_title">
                                                            ...
                                                            <div className="geodir-category-location"><a href="#"><i className="fas fa-map-marker-alt"></i> 40 Journal Square Plaza, NJ,  USA</a></div>
                                                        </div>
                                                        <div className="listing-rating-count-wrap">
                                                            <div className="review-score">5.0</div>
                                                            <div className="listing-rating card-popup-rainingvis" data-starrating2="5"></div>
